    ...
    <div class="dcard" id="home-{home_id}">
      <div class="dcard-hero">
        <div class="dcard-hero-left">
          ...
          <div class="dcard-addr">TODO: street address</div>
          <div class="dcard-city">TODO: City, OH zip</div>
...
def _comps_html(comps, comp_range, data, ppsf):
    ...
    rows.append(f"""            <tr class="ct-subj">
              <td><strong>TODO: address</strong> <span style="font-size:10px;color:var(--gold2)">(this home)</span></td>
